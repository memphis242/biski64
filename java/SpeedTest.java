...
public class SpeedTest extends Biski64 {
    ...
    private void benchmark() {
        ...
        System.out.println("Time for ThreadLocalRandom.nextLong(): " + threadLocalRandomTime + " ms");
        System.out.println();
        ...
        System.out.println("biski64.nextLong() is " + (int) (100.0 * (threadLocalRandomTime / bitsTime - 1)) + "% faster than ThreadLocalRandom (nextLong)");
    }
